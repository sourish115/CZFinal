...
public class MyOpenChannelListFragment extends Fragment {
    ...
    public static MyOpenChannelListFragment newInstance() {
        MyOpenChannelListFragment fragment = new MyOpenChannelListFragment();
        return fragment;
    }
...
//                temp.equals(list);
//                if(PreferenceUtils.getMyOpenChannels().isEmpty() || PreferenceUtils.getMyOpenChannels() == null)
//                    list.removeAll(list);
//                else{
                int templen = list.size();
                    for(int i=0;i<templen;i++){
                        if(!(PreferenceUtils.getMyOpenChannels().contains(list.get(i).getUrl()))){
                            list.remove(i);
                            i--;
                            templen--;
                        }
