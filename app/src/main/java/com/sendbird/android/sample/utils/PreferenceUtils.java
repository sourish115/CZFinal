...
public class PreferenceUtils {
    ...
    private static final String PREFERENCE_KEY_MY_GROUPS_URL = "MygroupsUrl";
    ...
    public static void setMyOpenChannels(Set<String> stringSet){
        SharedPreferences.Editor editor = getSharedPreferences().edit();
        editor.putStringSet(PREFERENCE_KEY_MY_GROUPS_URL,stringSet).apply();
    }

    public static Set<String> getMyOpenChannels(){
        Set<String> temp;
        temp = new HashSet<String>();
        return getSharedPreferences().getStringSet(PREFERENCE_KEY_MY_GROUPS_URL,temp);
    }
}
